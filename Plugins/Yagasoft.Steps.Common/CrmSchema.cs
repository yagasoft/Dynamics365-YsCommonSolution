...
*/
	...
	public partial class CustomJob : GeneratedEntity<CustomJob.RelationName>
	{
		...
		public RecurrenceRule[] RecurrenceRulesOfldv_ldv_customjob_ldv_recurrencerule

		{
			...
			set
			{
				OnPropertyChanging("RecurrenceRulesOfldv_ldv_customjob_ldv_recurrencerule");
				if (RelatedEntities.IsReadOnly) { throw new Exception("Relationship collection is read only. The context that loaded this entity must be used to create relationships."); }
                if (value != null)
				...
				OnPropertyChanged("RecurrenceRulesOfldv_ldv_customjob_ldv_recurrencerule");
			}
		}
	...
	public partial class ldv_ldv_recurrencerule_ldv_recurrenceruleex : GeneratedEntity<ldv_ldv_recurrencerule_ldv_recurrenceruleex.RelationName>
	{
		...
		public static class Fields
		{
			...
			public const string ldv_ldv_recurrencerule_ldv_recurrenceruleexIdId = "ldv_ldv_recurrencerule_ldv_recurrenceruleexid";
			public const string ldv_recurrenceruleexceptionid = "ldv_recurrenceruleexceptionid";
			public const string ldv_recurrenceruleid = "ldv_recurrenceruleid";
			...
			public static class Labels
			{
				public static class ldv_ldv_recurrencerule_ldv_recurrenceruleexIdId
				{
				}

				public static class ldv_recurrenceruleexceptionid
				{
				}

				public static class ldv_recurrenceruleid
				{
				}
		...
		public static class Relations
		{
			...
			public static class NToN
			{
				...
				public const string RecurrenceRulesOfldv_ldv_recurrencerule_ldv_recurrenceruleexce = "ldv_ldv_recurrencerule_ldv_recurrenceruleexce";
			}
		}
	...
	public partial class RecurrenceRule : GeneratedEntity<RecurrenceRule.RelationName>
	{
		...
		protected override IDictionary<string, object[]> RelationProperties { get {
			...
			relationProperties["ExceptionGroupings"] = new object[] { "ExceptionGroupings", "ldv_recurrenceruleexceptiongrouping", "ldv_ldv_recurrencerule_ldv_recurrenceexgrou", "ldv_recurrenceruleexceptiongroupingid", "ldv_recurrenceruleexceptiongroupingid", "ldv_recurrenceruleid", "ldv_recurrenceruleid", "ldv_ldv_recurrencerule_ldv_recurrenceexgroup", typeof (RecurrenceRuleExceptionGrouping[]) };
		...
		public static class Relations
		{
			public static class OneToN
			{
				public const string CustomJobsOfRetrySchedule = "ldv_ldv_recurrencerule_ldv_customjob_RetrySchedule";
			}
			...
			public static class NToN
			{
				...
				public const string Jobs = "ldv_ldv_customjob_ldv_recurrencerule";
				public const string ExceptionGroupings = "ldv_ldv_recurrencerule_ldv_recurrenceexgroup";
				public const string Exceptions = "ldv_ldv_recurrencerule_ldv_recurrenceruleexce";
			}
		}
	...
	public partial class RecurrenceRuleException : GeneratedEntity<RecurrenceRuleException.RelationName>
	{
		...
		public static class Enums
		{
			...
			public static class Names
			{
				public const string Month = "ldv_month";
				public const string MonthlyDayOccurrence = "ldv_monthlydayoccurrence";
				public const string WeekDay = "ldv_weekday";
				public const string Status = "statecode";
				public const string StatusReason = "statuscode";
			...
			public static class Labels
			{
				public static class Month 
				{
					...
					public static int GetValue(string label, int languageCode = 1033)
					{
						return CrmHelpers.GetValue(typeof(Month), label, languageCode);
					}
				}
		...
		public static class Fields
		{
			...
			public const string DaysOfTheMonth = "ldv_daysofthemonth";
			public const string EndDate = "ldv_enddate";
			public const string Hours = "ldv_hours";
			public const string Minutes = "ldv_minutes";
			public const string Month = "ldv_month";
			public const string MonthlyDayOccurrence = "ldv_monthlydayoccurrence";
			public const string Months = "ldv_months";
			public const string Name = "ldv_name";
			public const string RecurrenceRuleExceptionId = "ldv_recurrenceruleexceptionid";
			public const string StartDate = "ldv_startdate";
			public const string WeekDay = "ldv_weekday";
			public const string WeekDays = "ldv_weekdays";
			public const string Years = "ldv_years";
			public const string ModifiedBy = "modifiedby";
			public const string ModifiedOn = "modifiedon";
			public const string ModifiedByDelegate = "modifiedonbehalfby";
			public const string RecordCreatedOn = "overriddencreatedon";
			...
			public static class Labels
			{
				...
				{
					public const string _1033 = "Minutes";
				}

				public static class Month
				{
					public const string _1033 = "Month";
				}
				...
				public static class RecurrenceRuleExceptionId
				{
					public const string _1033 = "Recurrence Rule Exception";
				}
				...
				{
					public const string _1033 = "Years";
				}
		...
		public static class Relations
		{
			...
			public static class NToN
			{
				...
				public const string RecurrenceRulesOfldv_ldv_recurrencerule_ldv_recurrenceruleexce = "ldv_ldv_recurrencerule_ldv_recurrenceruleexce";
				public const string RecurrenceRuleExceptionGroupingsOfldv_ldv_recurrenceruleexceptiongrouping_ldv_r = "ldv_ldv_recurrenceruleexceptiongrouping_ldv_r";
			}
		}
